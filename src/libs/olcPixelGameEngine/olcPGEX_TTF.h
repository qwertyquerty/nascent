...
namespace olc {
    ...
    public:
        ...
        void DrawString(std::string string, int x, int y,
            ...
            std::u32string string32(string.begin(), string.end());
            FT_Matrix rotMat;
            ...
            for (size_t i = 0; i < string32.size(); i++) {
                char32_t chr = string32[i];
                Font *toUse = this;
                ...
                if (prevToUse == toUse) {
                    FT_Vector kern;
                    FT_Get_Kerning(fontFace, string32[i - 1], chr,
        ...
        FontRect GetStringBounds(std::string string, float angle = 0.0f) {
            ...
            minX /= 64;
            minY /= 64;
            maxX = (int)std::ceil((double)maxX / 64);
            maxY = (int)std::ceil((double)maxY / 64);
